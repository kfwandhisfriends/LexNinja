...
public class Defend_Ninja extends CustomCard
{
    ...
    public Defend_Ninja() {
        super(ID, NAME, IMG_PATH, COST, DESCRIPTION, CardType.SKILL, AbstractCardEnum.Ninja_COLOR, CardRarity.BASIC, CardTarget.SELF);
        //添加基础防御标签和将格挡设为5
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard)new Defend_Ninja();
    }
