...
public class Strike_Ninja extends CustomCard{
    ...
    public Strike_Ninja() {
        super(ID, NAME, IMG_PATH, COST, DESCRIPTION, CardType.ATTACK, AbstractCardEnum.Ninja_COLOR, CardRarity.BASIC, CardTarget.ENEMY);
        //添加基础攻击标签和将伤害设为6
    ...
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return (AbstractCard)new Strike_Ninja();
    }
    @Override
