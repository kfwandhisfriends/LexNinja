...
public class BladeDefenceAction extends AbstractGameAction {
    private int damage;

    public BladeDefenceAction(AbstractCreature target,int damage) {
        this.damage= damage;
        this.setValues(target, new DamageInfo(AbstractDungeon.player,damage, DamageInfo.DamageType.NORMAL));
        ...
        if (this.shouldCancelAction()) {
            ...
            if (this.isDone) {
                ...
                if (this.target.lastDamageTaken > 0) {
                    this.addToTop(new ApplyPowerAction(this.source,this.source,new ParryPower(this.source, this.target.lastDamageTaken),this.target.lastDamageTaken));
